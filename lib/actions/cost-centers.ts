 ...
 *
 * Handles:
 * - Cost center CRUD operations (board members only)
 * - Cost center transactions and balances
 * - FLIGHT CHARGE REVERSALS (reverseCostCenterFlightCharge function)
 *
 ...
 * See reverseCostCenterFlightCharge() documentation for details.
 */
...
/**
 * Reverse a flight charge (cost center transaction)
 *
 ...
 *
 * NOTE: This is different from reverseCostCenterTransaction() in accounting.ts,
