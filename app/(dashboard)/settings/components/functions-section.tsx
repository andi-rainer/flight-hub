      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>
              Manage member functions and their yearly membership rates
            </CardDescription>
          </div>
            ...
            <DialogContent>
              <form onSubmit={handleCreate}>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Add a new member function with its yearly rate
                  </DialogDescription>
                </DialogHeader>
                <div className="space-y-4 py-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="yearly_rate">Yearly Rate (CHF)</Label>
                    <Input
                      id="yearly_rate"
                      type="number"
                      step="0.01"
              ...
              {functions.length === 0 ? (
                ...
                functions.map((func) => (
                  <TableRow key={func.id}>
                    ...
                    <TableCell>CHF {func.yearly_rate.toFixed(2)}</TableCell>
                          ...
                          <DialogContent>
                            <form onSubmit={handleUpdate}>
                              <DialogHeader>
                                ...
                                <DialogDescription>
                                  Update function details and yearly rate
                                </DialogDescription>
                              </DialogHeader>
                              <div className="space-y-4 py-4">
                                <div className="space-y-2">
                                ...
                                <div className="space-y-2">
                                  <Label htmlFor="edit-yearly_rate">Yearly Rate (CHF)</Label>
                                  <Input
                                    id="edit-yearly_rate"
                                    type="number"
                                    step="0.01"
